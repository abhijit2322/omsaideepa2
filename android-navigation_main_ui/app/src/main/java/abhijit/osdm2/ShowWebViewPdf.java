...
public class ShowWebViewPdf extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_web_view_pdf);
        ...
        String webViewUrl = pdfurl;//"http://www.androidexample.com/media/webview/details.html";

        System.out.println("Abhijit its coming ShowWebViewPdf >>>>>>>>>>>>>>>>>>>>>>"+webViewUrl);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                ...
                if (progressDialog == null && url.contains("androidexample")
                    ...
                    progressDialog = new ProgressDialog(ShowWebViewPdf.this);
