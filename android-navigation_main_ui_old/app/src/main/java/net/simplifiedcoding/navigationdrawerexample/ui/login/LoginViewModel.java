...
import net.simplifiedcoding.navigationdrawerexample.PdfMainActivity;
import net.simplifiedcoding.navigationdrawerexample.data.LoginRepository;
import net.simplifiedcoding.navigationdrawerexample.data.Result;
import net.simplifiedcoding.navigationdrawerexample.data.model.LoggedInUser;
