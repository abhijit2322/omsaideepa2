...
public class FlatOwner {
   ...
   public FlatOwner(int id, String ownername, String flatnumber, String ownercontactno, String maintaincepaid, String email,String isrented,String mntcaretaker,String apartmentid) {
       this.id = id;
