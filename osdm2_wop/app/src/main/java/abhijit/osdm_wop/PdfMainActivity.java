...
public class PdfMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Setup webview
        ...
        flat.setApartmentid(AppSettingsData.getApartmentID());

        emailid=getAllEmails(flat);
   ...
   public void ShowpdfFile(String pdf_data)
    {
        System.out.println("Abhijit its coming ShowpdfFile.............>>>>>>>>>>>>>");
        try {
    ...
    {
        System.out.println("Abhijit its coming pdfLoadImages.............>>>>>>>>>>>>>"+data);
        if(data.length>0)
            System.out.println("Abhijit its coming pdfLoadImages..data contain"+data.length);
        else {
            ReadPdfFile(myPdfUrl);
            ShowpdfFile(pdfData);
        }
        try
        {
            ...
            new AsyncTask<Void, Void, String>()
            {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    System.out.println("Abhijit its coming Async ---onPreExecute");
                    progressDialog = new ProgressDialog(PdfMainActivity.this);
                    ...
                    progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                        ...
                        public void onCancel(DialogInterface dialog) {
                             cancel(true);
                            Toast.makeText(PdfMainActivity.this,"AsyncTask is stopped",Toast.LENGTH_LONG).show();
                        }
                    });
                    progressDialog.show();
                }
                ...
                {
                    System.out.println("Abhijit its coming Async ---onPostExecute");
                ...
                protected String doInBackground(Void... params)
                {
                    try
                    {
                        System.out.println("Abhijit its coming Async ---doInBackground");
   ...
   public void permision_check()
   {
    ...
    public void ReadPdfFile(String location)
    {
        {
            byte[] data=null;
            try
    ...
    public void uploadimage(String location)
    {
       ...
       // pdfData=imageData;
        ...
        ImageDB imagedb=new ImageDB(1,location,imageData,monthyr,AppSettingsData.getApartmentID());
        UploadImage(imagedb);
    ...
    public void UploadImage(ImageDB imagedb)
    {
        ...
        apiService.uploadImage(imagedb).enqueue(new Callback<ImageDB>() {
            ...
            public void onResponse(Call<ImageDB> call, Response<ImageDB> response) {
                System.out.println("I am here ...<Monthly expence Class>..UploadImage-onResponse");
            ...
            public void onFailure(Call<ImageDB>  call, Throwable t) {
                System.out.println("This in  Failure    UploadImage>>>>>. "+t.getMessage());
...
//
    ...
    public String [] getAllEmails1(FlatOwner apartmentid)
    {
        String url = "https://postgres2322.herokuapp.com/common/";
        Log.i("autolog<GetEmails>", "https://postgres2322.herokuapp.com/common/");
        HerokuService apiService = RetrofitClient.getApiService();
        apiService.getAllEmailids(apartmentid).enqueue(new Callback<List<String>>() {
            @Override
    ...
    public String [] getAllEmails(FlatOwner apatmentid)
    {
        System.out.println("I am here ...<Monthly expence Class>..GetLoginRule-RETROFIT");
        HerokuService apiService = RetrofitClient.getApiService();
        apiService.getAllEmailids(apatmentid).enqueue(new Callback<List<String>>() {
            @Override
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                System.out.println("I am here ...<LoginActivity>..GetLoginRule-onResponse");
                if(response.isSuccessful()) {
