package abhijit.osdm_wop.rettrofitsupport;
    ...
    static final class RetryCallback<T> implements Callback<T> {
        ...
        public void onFailure(@NonNull Call<T> call, @NonNull Throwable t) {
            ...
            if (retryCount.incrementAndGet() <= maxRetries) {
               // retryCall();
                if(find_str(t.getMessage(),"Exception")>0)
                    System.out.println("This is Exception error..............................");

                callback.onFailure(call,
                        new TimeoutException(String.format("Time out due to :", t.getMessage())));
