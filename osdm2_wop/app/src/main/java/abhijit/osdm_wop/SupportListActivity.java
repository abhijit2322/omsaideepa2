...
public class SupportListActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SuppTable suppTable=new SuppTable();
        suppTable.setApartmentid(AppSettingsData.getApartmentID());
        List<SuppTable> userLists = getSupportList(suppTable);
         ...
         /*   case R.id.update:
            ...
            case R.id.support_call:
                ...
                try {
                    ...
                    Intent intentDial = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + support.getCphoneno()));
            ...
            case R.id.support_sms:
                ...
                smsIntent.putExtra("address","+91"+support.getCphoneno());
            ...
            case R.id.support_sms_others:
                // do your code
                Intent smsIntent1 = new Intent(android.content.Intent.ACTION_VIEW);
                smsIntent1.setType("vnd.android-dir/mms-sms");
                smsIntent1.putExtra("address","+91"+support.getCphoneno());
                smsIntent1.putExtra("sms_body","");
                smsIntent1.setFlags(android.content.Intent.FLAG_ACTIVITY_NEW_TASK);
   ...
   private List<SuppTable> getSupportList(SuppTable suppTable) {
        /*
        ...
        apiService.getSupportList(suppTable).enqueue(new Callback<List<SuppTable>>() {
            @Override
